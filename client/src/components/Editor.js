  ...
  return (
    <div>
      <div className="d-flex row justify-content-center">
        <Button color="primary" onClick={addEditor1} className="mb-3 mr-2">
          One Editor
        </Button>
        <Button color="primary" onClick={addEditor2} className="mb-3 mr-2">
          Two Editors
        </Button>
        <Button color="primary" onClick={addEditor3} className="mb-3">
          Three Editors
        </Button>
      </div>
      <div className="d-flex row justify-content-center">
        <div className="editor mr-5">
          ...
          <Button
            color="primary"
            onClick={toClipBoard1}
            className="float-right m-1"
          >
            Copy Code
          </Button>
          <label
            className="mb-0 mt-3 ml-1 languageSelect"
            for="formGroupExampleSearch"
          >
            Language
          </label>
          <select
            className="form-control languageSelect"
            id="languageSelect1"
            onChange={languageSelect1}
          >
        ...
        <div>
          {showResults2 ? (
            <div className="editor mr-5">
              ...
              <Button
                color="primary"
                onClick={toClipBoard2}
                className="float-right m-1"
              >
                Copy Code
              </Button>
              <label className="mb-0 mt-3 ml-1" for="formGroupExampleSearch">
                Language
              </label>
              <select
                className="form-control languageSelect"
                id="languageSelect2"
                onChange={languageSelect2}
              >
                <option value="html">HTML</option>
                <option value="css">CSS</option>
                <option value="handlebars">Handlebars</option>
            ...
            <div className="d-flex row justify-content-center">
              <div>
                <div className="editor ml-3 mr-5">
                  ...
                  <label
                    className="mb-0 mt-3 ml-1"
                    for="formGroupExampleSearch"
                  >
                    Language
                  </label>
                  <select
                    class="form-control languageSelect"
                    id="languageSelect2"
                    onChange={languageSelect2}
                  >
                    <option value="html">HTML</option>
      ...
      <Container>
        <div>
          <label className="mb-2 mt-3  " for="formGroupExampleSearch">
            Visibility
          </label>
          <select
          ...
          >
            ...
            {/* might have to change value to true or false I think */}
        ...
        <Button color="primary mt-3" onClick={saveFromEditor}>
          Submit
        </Button>
      </Container>
    </div>
